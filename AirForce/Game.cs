...
public class Game
{
    ...
    public Game(int gameFieldWidth, int gameFieldHeight)
    {
        ...
        int playerStartY = (gameFieldHeight - groundY) / 2;
    ...
    private void CreateEnemy()
    {
        ...
        switch (randomNumber)
        {
            ...
            case 2:
            case 3:
                GameObject.Create(typeof(BomberShip), gameFieldWidth, Random.Next(0, groundY));
                break;
            case 4:
            case 5:
            case 6:
                GameObject.Create(typeof(ChaserShip), gameFieldWidth, Random.Next(0, groundY));
                break;
            case 7:
            case 8:
            case 9:
            case 10:
                GameObject.Create(typeof(Bird), gameFieldWidth, Random.Next(gameFieldHeight / 2, groundY));
                break;
            default:
